        ...
        <div class="EisenhowerMatrix" >
            ...
            <p class="EisenhowerMatrix__name">Важные <br>
                ...
                <ul class="EisenhowerMatrixItem__tasks importantUrgentTasks" >
                    <TaskItemComponent  v-for="(task, index) in importantUrgentTasks" :key="index" :task="task" /> 
                </ul>
                <ul class="EisenhowerMatrixItem__tasks importantNotUrgentTasks"  >
                    <TaskItemComponent  v-for="(task, index) in importantNotUrgentTasks" :key="index" :task="task" /> 
                </ul>
                <p class="EisenhowerMatrix__name">Не важные</p>
                <ul class="EisenhowerMatrixItem__tasks notImportantUrgentTasks"  >
                    <TaskItemComponent  v-for="(task, index) in notImportantUrgentTasks" :key="index" :task="task" />
            </ul>
                    
                <ul class="EisenhowerMatrixItem__tasks notImportantNotUrgentTasks" >
                    <TaskItemComponent  v-for="(task, index) in notImportantNotUrgentTasks" :key="index" :task="task" />
                </ul>
        ...
        <div class="kanban" >
            ...
            <p class="kanban__name">Сделано</p>
                ...
                <ul class="kanban__tasks" >
                    <TaskItemComponent  v-for="(task, index) in toDoTasks" :key="index" :task="task" /> 
                </ul>
                <ul class="kanban__tasks"  >
                    <TaskItemComponent  v-for="(task, index) in doingTasks" :key="index" :task="task" />
                </ul>
                <ul class="kanban__tasks"  >
